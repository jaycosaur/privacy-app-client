            ...
            !this.props.isFetching?<div>
                <Layout.Header style={{background: primaryThemeShades[3], boxShadow: "0 5px 5px -5px #333", zIndex: 100, position: "fixed", left: 0, top: 64, width: "100%"}}>
                    <div style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
                        ...
                        <div>
                        <Button style={{ background: highlightThemeShades[2], borderColor: highlightThemeShades[2], color: primaryThemeShades[3]}}><strong><Icon type="plus-circle-o" /> CREATE NEW POLICY ALERT</strong></Button>
                        </div>
                    </div>  
                </Layout.Header>
