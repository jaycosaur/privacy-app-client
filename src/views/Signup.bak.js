    ...
    render() {
      ...
      return (
        <Form onSubmit={this.handleSubmit} className="login-form">
          ...
          />
          <FormItem>
            <Button loading={this.props.isLoading} disabled={!this.state.verified} style={{marginTop: 16, width: "100%", background: "#f97794", height: 64}} size="large" htmlType="submit" className="login-form-button">
